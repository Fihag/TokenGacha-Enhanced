...
- **限定活动卡池「限定池」**:每赛季 21 天自动轮换,到期自动换下一批限定模型。当前赛季 DeepSeek V5 系列(UTR·72 / UR·61);下赛季将登场 **Claude Opus 6**(UTR·79)与 **Gemini 4 Pro**(UTR·75)。90 抽大保底必出当期限定
...
| 限定池(轮换) | ¥800 / 十连 ¥7600 | 限定 UP,90 抽大保底必出当期限定 |
