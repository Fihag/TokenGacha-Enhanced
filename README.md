...
### 全新内容
- **UTR 超神话档位**(智能指数 ≥62):高于 UR 的新稀有度,专属红金配色与音效
- **限定活动卡池「流光限定池」**:限定模型 **DeepSeek V5 Pro**(UTR·72)与 **DeepSeek V5 Flash**(UR·61)仅此池可出,90 抽大保底必出限定,活动倒计时结束后自动下架
- **限定卡加成**:使用限定模型接单,该单收入 **×2**(删库赔偿不翻倍)
- **每日签到**:7 天循环奖励 ¥100 → ¥1000 + 皮肤券,断签重置
- **日常任务**:抽卡 5 次 / 工作 10 单 / 日入 ¥500,每日 0 点刷新
- **皮肤系统**:5 套主题(经典蓝/暗夜紫/赛博霓虹/金色传说/粉甜梦境),抽卡 1.5% 概率掉落,皮肤券可兑换
- **数据分析页**:抽卡分布柱状图、余额走势折线图、稀有度占比环形图、图鉴进度、厂商分布,全部 canvas 手绘

### 模型与数值更新
- 模型库扩充至 **48 个**(新增 Grok 4.6、Muse Spark 1.1/1.2、Gemini 3.7 Flash、DeepSeek V4 Pro 0813、Qwen3.8 27B 等),智能指数按 2026-08 最新数据校准
...
| 王者盲盒 | ¥500 / 十连 ¥4700 | 不出 N 垃圾,UR 6% |
| 流光限定池 | ¥800 / 十连 ¥7600 | 限定 UP,90 抽大保底必出限定 |

- 每池 50 抽无 SSR+ 触发保底(80% SSR / 20% UR),限定池 90 抽大保底;十连必出 SR+
